<!-- Snapshot of the SWDB databook glossary, the source of every definition
     whose card cites "databook glossary". Taken from
     AllenSWDB/allenswdb.github.io main, commit 00942de, the newest commit
     touching databook/glossary.md as of 2026-08-19. Kept so the wording can
     be re-verified: those definitions are carried word for word, not rewritten.
     Do not edit; refresh it from upstream instead. -->
